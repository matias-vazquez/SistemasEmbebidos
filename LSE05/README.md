...
In your project, the Raspberry Pi must be able to communicate with both devices through the I<sup>2</sup>C protocol. To install the Python tools that allow I<sup>2</sup>C communications between the Raspberry Pi and hooked devices, as well as diagnostic tools, type in the following:
```
$ sudo apt-get install -y python-smbus i2c-tools
```
Once installation is complete, test whether the modules are fully loaded:
```
$ lsmod | grep i2c_
i2c_bcm2835		16384 0
i2c_bcm2708		16384 0
